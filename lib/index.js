...
var te = (e, t) => {
    for (var o in t) _(e, o, { get: t[o], enumerable: !0 });
  },
  E = (e, t, o, n) => {
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (let c of X(t))
        !ee.call(e, c) &&
          c !== o &&
          _(e, c, { get: () => t[c], enumerable: !(n = F(t, c)) || n.enumerable });
    return e;
  };
var oe = (e, t, o) => (
    (o = e != null ? Z(K(e)) : {}),
    E(t || !e || !e.__esModule ? _(o, 'default', { value: e, enumerable: !0 }) : o, e)
  ),
  ne = (e) => E(_({}, '__esModule', { value: !0 }), e);
var ge = {};
te(ge, { default: () => ue });
...
var z = {
  splash: {
    ...
    buttons: { manage: 'Beheer cookies', accept: 'Ik accepteer cookies' },
  },
  manage: {
    ...
    switches: { on: 'Aan', off: 'Uit' },
    buttons: { all: 'Overal toestemming voor geven', save: 'Keuze opslaan' },
...
var M = {
  splash: {
    ...
    buttons: { manage: 'Manage cookies', accept: 'I accept cookies' },
  },
  manage: {
    ...
    buttons: { all: 'Accept all', save: 'Save choice' },
    ...
    c !== null &&
      ...
      Object.keys(c).forEach((r) => {
        Object.prototype.hasOwnProperty.call(c, r) &&
          (typeof o[r] == 'object' && o[r] && typeof c[r] == 'object' && c[r]
            ? (o[r] = x(o[r], c[r]))
            : (o[r] = c[r]));
      });
  }
...
var j = (e) => {
    let t = typeof e == 'object' && Object.keys(e).length ? e : {};
    return x({}, w, t);
  },
  L = () => {
    let e = window.tdeCookieConsentContent,
      t = typeof e == 'object' && Object.keys(e).length ? e : {};
    return x({}, A, t);
  },
  i = () => {
    try {
      return JSON.parse(JSON.stringify(window.tdecc.config)), window.tdecc.config;
    } catch {
      return w;
    }
  };
var v = (e) => {
    let t = e.replace(/([.*+?^$(){}|[\]/\\])/g, '\\$1'),
      o = document.cookie.match(RegExp(`(?:^|;\\s*)${t}=([^;]*)`));
    return o ? o[1] : null;
  },
  O = (e, t, o, n, c, r) => {
    let $ = {
  ...
  D = (e, t, o) => {
    document.cookie = `${e}=${t ? `;path=${t}` : ''}${o ? `;domain=${o}` : ''};expires=${new Date(
      0
    ).toUTCString()}`;
  };
var d = () => ({
  ...
  b = (e = void 0) => {
    let t = e?.renderSelector || '[data-tdecc-render]';
    return {
      elements: document.querySelectorAll(`${t}:not([data-tdecc-rendered])`),
      manage: document.querySelectorAll('[href$="#manage-cookies"]'),
    };
  };
var p = () => {
    let e = v(i().cookieName) || !1;
  ...
  h = (e) => {
    ...
    let t = m();
    if (!t) return !1;
    let o = typeof e == 'string' ? e.split('') : e;
    for (let n = 0; n < o.length; n += 1)
      if (
        (o[n].indexOf('cookie-accept-') === -1 && (o[n] = `cookie-accept-${o[n]}`),
        t.indexOf(o[n]) === -1)
      )
        return !1;
    return !0;
...
var a = (e) => {
  throw new Error(`TDE Cookieconsent: ${e || 'An error has occurred'}`);
};
var H = (e = void 0, t = void 0) => `<svg width="${e || 24}" height="${
  t || 24
...
var N = (e = void 0, t = void 0) => `<svg width="${e || 25}" height="${
  t || 19
...
var P = (e) => {
  ...
  return `<ul class="tdecc__links">${t}</ul>`;
};
var re = (e, t) => {
    let o = '';
    for (let n = 0; n < e.length; n += 1) {
      let c = n + 1;
      o += `<div class="tdecc__manage__option">
    ...
    return `<div class="tdecc__manage__options">${o}</div>`;
  },
  I = (e, t) =>
    t?.manageable
      ? typeof e != 'object' || !Object.keys(e)
        ? (a('Content not found'), '')
        : t?.consentOptions.length
    ...
    <div class="tdecc__manage__footer">${e.footer}</div>
        ...
        : (a('No concentoptions are given'), '')
      : '';
var q = (e, t) =>
  typeof e != 'object' || !Object.keys(e)
    ? (a('Given content is not valid'), '')
...
var ie = () => {
    let { content: e } = window.tdecc,
      { config: t } = window.tdecc;
    return !e || !e
      ? (a('Content and config not found'), '')
      : `
...
var ae = () => {
  ...
  l = (e = void 0) => {
    (e || !i().exceptionUrls.find((t) => t === window.location.pathname)) &&
      (document.body.className += ` show-tdecc-overlay show-tdecc-overlay--${ae()}`),
      e && (document.body.className += ' show-tdecc-overlay--closeable');
  },
  J = () => {
    let e = document.createElement('div');
    (e.className = 'tdecc'), (e.innerHTML = W()), document.body.appendChild(e);
  },
  Q = () => {
    let e = m(),
      { wrapper: t } = d();
    if (!t || !t || !e.length) return;
    t.querySelectorAll('input[type="radio"]').forEach((n) => {
      n.value === '0' && (n.checked = !0);
    });
    for (let n = 0; n < e.length; n += 1)
      t.querySelectorAll(`input[name="${e[n]}"][value="1"]`).forEach((r) => {
        r.checked = !0;
      });
  },
  u = () => {
    ...
    e.wrapper &&
      i().manageable &&
      (e.sectionStart && (e.sectionStart.style.display = 'none'),
      e.sectionManage && (e.sectionManage.style.display = 'block'));
  };
var g = () => {
  ...
  B = () => {
    let { wrapper: e } = d();
    e &&
      e.querySelectorAll('input[type="radio"][value="1"]').forEach((t) => {
        t.checked = !0;
      });
  },
  k = (e, t) => {
    !e ||
      !t ||
      (O(i().cookieName, JSON.stringify({ accepted: e, info: t }), 365),
      (window.tdecc.cookies = { accepted: e, info: t }));
  },
  C = () => {
    let e = d(),
      t = ['cookie-accept-essential'],
      o = {
        v: i().version,
        accepted: p()?.info?.accepted || new Date().toISOString(),
        updated: new Date().toISOString(),
      };
    if (e.optionsAll.length / 2 !== e.optionsChoosen.length) {
      e.errorMessage.style.display = 'block';
      return;
    }
    e.optionsChoosen.forEach((n) => {
      n.value === '1' && t.push(n.name);
    }),
      k(t, o),
      g(),
      s();
...
var G = () => {
    let e = d();
    e.save &&
      e.save.addEventListener('click', (t) => {
        t.preventDefault(), C();
      }),
      e.saveAll &&
        e.saveAll.forEach((t) => {
          t.addEventListener('click', (o) => {
            o.preventDefault(), B(), C();
          });
        }),
      e.close &&
      ...
      e.manage &&
        e.manage.addEventListener('click', (t) => {
          t.preventDefault(), u();
        });
  },
  T = () => {
    ...
    e.manage &&
      e.manage.forEach((t) => {
        t.addEventListener('click', (o) => {
          o.preventDefault(), l(!0), u();
        });
      });
  };
var R = oe(require('postscribe'));
var U = () => {
  let { content: e } = window.tdecc;
  return e
    ? `
...
var de = () => Date.now().toString(36) + Math.random().toString(36).substr(2),
  se = (e) => {
    if (e.dataset.tdeccIdentifier) return;
    let t = de(),
      o = U();
    if (!o) return;
    let n = document.createElement('div');
    (n.dataset.tdeccIdentifier = t),
      (n.className = 'tdecc-notification'),
      (n.innerHTML = o),
      e.after(n),
      (e.dataset.tdeccIdentifier = t);
  },
  le = (e) => {
    let t = e.dataset.tdeccIdentifier;
    if (!t) return;
    let o = document.querySelector(`.tdecc-notification[data-tdecc-identifier="${t}"]`);
    o && (o.outerHTML = '');
  },
  pe = () => {
    let e = i();
    b(e).elements.forEach((t) => {
      if (!t.dataset.tdeccPermissions) return;
      let o = t.dataset.tdeccPermissions;
      if (((o = o.replace(/\s+/g, '')), !h(o.split(',')))) {
        t.hasAttribute('data-tdecc-show-notification') &&
          (se(t), delete t.dataset.tdeccShowNotification);
        return;
      }
      le(t);
      let n = document.createElement('textarea');
      (n.innerHTML = t.innerHTML),
        (0, R.default)(t.parentElement, n.value),
        (t.dataset.tdeccRendered = '1');
    });
  },
  Y = pe;
var S = () => {
  ...
  V = () => {
    let e = p(),
      ...
      o = !0;
    if (
      ((!e.info || !e.info.v || e.info.v !== t.version) && (o = !1),
      e.accepted || (o = !1),
      t.exceptionUrls.find((n) => n === window.location.pathname) && (o = !0),
      o)
    ) {
      (window.tdecc.cookies = e), g(), k(e.accepted, e.info);
      return;
    }
    S();
  };
window.tdecc = window.tdecc || {};
window.tdecc.initialized = !1;
...
var me = () => ({
    ...
    init(e) {
      if (window.tdecc.initialized) return;
      let t = j(e),
        o = L(),
        n = v(t.cookieName) || !1;
      if (
        ((window.tdecc.config = t),
        (window.tdecc.content = o[t.language]),
      ...
      G(), T(), (window.tdecc.initialized = !0);
    },
  }),
  ue = me();
