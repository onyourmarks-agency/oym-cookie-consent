    ...
    <g fill-rule="nonzero">
      ...
      <a href="${e[o].href}">
        ...
        <div class="tdecc__manage__option__radios">
          <input id="tdecc-option-${c}-on" type="radio" name="cookie-accept-${e[n].key}" value="1" checked disabled>
