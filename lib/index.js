var F=Object.create;var f=Object.defineProperty;var X=Object.getOwnPropertyDescriptor;var K=Object.getOwnPropertyNames;var ee=Object.getPrototypeOf,te=Object.prototype.hasOwnProperty;var oe=(e,t)=>{for(var o in t)f(e,o,{get:t[o],enumerable:!0})},E=(e,t,o,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let c of K(t))!te.call(e,c)&&c!==o&&f(e,c,{get:()=>t[c],enumerable:!(n=X(t,c))||n.enumerable});return e};var ne=(e,t,o)=>(o=e!=null?F(ee(e)):{},E(t||!e||!e.__esModule?f(o,"default",{value:e,enumerable:!0}):o,e)),ce=e=>E(f({},"__esModule",{value:!0}),e);var ge={};oe(ge,{default:()=>ue});module.exports=ce(ge);var{content:z}=window.tdecc,w={consentOptions:[{key:"essential",title:z.permissions.essential.title,desc:z.permissions.essential.description,notCustomizable:!0}],cookieName:"tdecc",exceptionUrls:[],explanationAnchors:[],language:"nl",manageable:!0,style:"bar",renderSelector:"[data-tdecc-render]",version:"1.0"};var M={splash:{title:"Mogen we even je aandacht?",desc:"Om een persoonlijke ervaring te bieden en onze website te verbeteren, plaatsen wij cookies.",buttons:{manage:"Beheer cookies",accept:"Ik accepteer cookies"}},manage:{title:"Cookie instellingen",desc:`Wij laten je graag een goede website zien, afgestemd op jouw voorkeuren.
    ...
    <g fill-rule="nonzero">
      ...
      </div>`}return`<div class="tdecc__manage__options">${o}</div>`},q=(e,t)=>t?.manageable?typeof e!="object"||!Object.keys(e)?(a("Content not found"),""):t?.consentOptions.length?`<div class="tdecc__manage" data-tdeccoverlay-section-manage>
    <h2 class="tdecc__manage__title">${e.title}</h2>
    <p class="tdecc__manage__desc">${e.desc}</p>
    ${ie(t.consentOptions,e)}
  ...
  </div>`:(a("No concentoptions are given"),""):"";var W=(e,t)=>typeof e!="object"||!Object.keys(e)?(a("Given content is not valid"),""):`<div class="tdecc__start" data-tdeccoverlay-section-start>
  ...
  </div>`;var ae=()=>{let{content:e}=window.tdecc,{config:t}=window.tdecc;return!e||!e?(a("Content and config not found"),""):`
    <div class="tdecc-content" data-tdeccoverlay data-tdeccoverlay-style-${t.style}>
        ...
        ${W(e?.splash,t)}
        ${q(e?.manage,t)}
        ${I(t?.explanationAnchors)}
    </div>`},J=ae;var de=()=>{switch(i().style){case"popup":return"popup";default:return"bar"}},s=()=>{document.body.className=document.body.className.replace(/\bshow-tdecc-overlay--popup|show-tdecc-overlay--bar|show-tdecc-overlay--closeable|show-tdecc-overlay\b/g,"")},l=(e=void 0)=>{(e||!i().exceptionUrls.find(t=>t===window.location.pathname))&&(document.body.className+=` show-tdecc-overlay show-tdecc-overlay--${de()}`),e&&(document.body.className+=" show-tdecc-overlay--closeable")},Q=()=>{let e=document.createElement("div");e.className="tdecc",e.innerHTML=J(),document.body.appendChild(e)},B=()=>{let e=m(),{wrapper:t}=d();if(!t||!t||!e.length)return;t.querySelectorAll('input[type="radio"]').forEach(n=>{n.value==="0"&&(n.checked=!0)});for(let n=0;n<e.length;n+=1)t.querySelectorAll(`input[name="${e[n]}"][value="1"]`).forEach(r=>{r.checked=!0})},u=()=>{let e=d();e.wrapper&&i().manageable&&(e.sectionStart&&(e.sectionStart.style.display="none"),e.sectionManage&&(e.sectionManage.style.display="block"))};var g=()=>{document.dispatchEvent(new Event("tdecc-changed"))},G=()=>{let{wrapper:e}=d();e&&e.querySelectorAll('input[type="radio"][value="1"]').forEach(t=>{t.checked=!0})},x=(e,t)=>{!e||!t||(D(i().cookieName,JSON.stringify({accepted:e,info:t}),365),window.tdecc.cookies={accepted:e,info:t})},C=()=>{let e=d(),t=["cookie-accept-essential"],o={v:i().version,accepted:p()?.info?.accepted||new Date().toISOString(),updated:new Date().toISOString()};if(e.optionsAll.length/2!==e.optionsChoosen.length){e.errorMessage.style.display="block";return}e.optionsChoosen.forEach(n=>{n.value==="1"&&t.push(n.name)}),x(t,o),g(),s()};var U=()=>{let e=d();e.save&&e.save.addEventListener("click",t=>{t.preventDefault(),C()}),e.saveAll&&e.saveAll.forEach(t=>{t.addEventListener("click",o=>{o.preventDefault(),G(),C()})}),e.close&&e.close.addEventListener("click",t=>{t.preventDefault(),s()}),e.manage&&e.manage.addEventListener("click",t=>{t.preventDefault(),u()})},T=()=>{let e=b();e.manage&&e.manage.forEach(t=>{t.addEventListener("click",o=>{o.preventDefault(),l(!0),u()})})};var Y=ne(require("postscribe"));var R=()=>{let{content:e}=window.tdecc;return e?`
    ...
    </div>`:(a("Content not found"),"")};var se=()=>Date.now().toString(36)+Math.random().toString(36).substr(2),le=e=>{if(e.dataset.tdeccIdentifier)return;let t=se(),o=R();if(!o)return;let n=document.createElement("div");n.dataset.tdeccIdentifier=t,n.className="tdecc-notification",n.innerHTML=o,e.after(n),e.dataset.tdeccIdentifier=t},pe=e=>{let t=e.dataset.tdeccIdentifier;if(!t)return;let o=document.querySelector(`.tdecc-notification[data-tdecc-identifier="${t}"]`);o&&(o.outerHTML="")},V=()=>{let e=i();b(e).elements.forEach(t=>{if(!t.dataset.tdeccPermissions)return;let o=t.dataset.tdeccPermissions;if(o=o.replace(/\s+/g,""),!h(o.split(","))){t.hasAttribute("data-tdecc-show-notification")&&(le(t),delete t.dataset.tdeccShowNotification);return}pe(t);let n=document.createElement("textarea");n.innerHTML=t.innerHTML,(0,Y.default)(t.parentElement,n.value),t.dataset.tdeccRendered="1"})};var S=()=>{H(i().cookieName)},Z=()=>{let e=p(),t=i(),o=!0;if((!e.info||!e.info.v||e.info.v!==t.version)&&(o=!1),e.accepted||(o=!1),t.exceptionUrls.find(n=>n===window.location.pathname)&&(o=!0),o){window.tdecc.cookies=e,g(),x(e.accepted,e.info);return}S()};window.tdecc=window.tdecc||{};window.tdecc.initialized=!1;window.tdecc.accepted=[];window.tdecc.info={};window.tdecc.content={};var me=()=>({getAllPermissions(){return m()},checkPermission(e){return h(e)},show(){l(!0),u()},hide(){s()},update(){T(),g()},init(e){if(window.tdecc.initialized)return;let t=L(e),o=O(),n=v(t.cookieName)||!1;if(window.tdecc.config=t,window.tdecc.content=o[t.language],window.tdecc.getAllPermissions=this.getAllPermissions,window.tdecc.checkPermission=this.checkPermission,window.tdecc.show=this.show,window.tdecc.hide=this.hide,window.tdecc.update=this.update,document.addEventListener("tdecc-changed",()=>{V()}),Q(),n)try{Z(),B()}catch{S(),l()}else l();U(),T(),window.tdecc.initialized=!0}}),ue=me();
