...
var O = (e = void 0, t = void 0) => `<svg width="${e || 24}" height="${
  t || 24
...
var D = (e = void 0, t = void 0) => `<svg width="${e || 25}" height="${
  t || 19
...
var Z = () => {
  ...
  l = (e = void 0) => {
    (e || !i().exceptionUrls.find((t) => t === window.location.pathname)) &&
      (document.body.className += ` show-tdecc-overlay show-tdecc-overlay--${Z()}`),
      e && (document.body.className += ' show-tdecc-overlay--closeable');
  },
  q = () => {
    let e = document.createElement('div');
    (e.className = 'tdecc'), (e.innerHTML = I()), document.body.appendChild(e);
  },
  W = () => {
    let e = m(),
      { wrapper: t } = d();
...
var g = () => {
  ...
  x = (e, t) => {
    !e ||
      !t ||
      (j(i().cookieName, JSON.stringify({ accepted: e, info: t }), 365),
...
var X = () => Date.now().toString(36) + Math.random().toString(36).substr(2),
  K = (e) => {
  ...
  te = () => {
    let e = i();
    v(e).elements.forEach((t) => {
      if (!t.dataset.tdeccPermissions) return;
      let o = t.dataset.tdeccPermissions;
      if (((o = o.replace(/\s+/g, '')), !b(o.split(',')))) {
        t.hasAttribute('data-tdecc-show-notification') &&
          (K(t), delete t.dataset.tdeccShowNotification);
        return;
      }
      ee(t);
      let n = document.createElement('textarea');
      (n.innerHTML = t.innerHTML), F(t.parentElement, n.value), (t.dataset.tdeccRendered = '1');
    });
  },
  G = te;
var T = () => {
  ...
  U = () => {
    ...
    if (
      ...
      (window.tdecc.cookies = e), g(), x(e.accepted, e.info);
      return;
    }
    T();
  };
...
var oe = () => ({
    ...
    init(e) {
      ...
      Q(), C(), (window.tdecc.initialized = !0);
    },
  }),
  vt = oe();
