var y={consentOptions:[],cookieName:"tdecc",exceptionUrls:[],explanationAnchors:[],language:"nl",manageable:!0,style:"bar",renderSelector:"[data-tdecc-render]",version:"1.0"};var $={splash:{title:"Mogen we even je aandacht?",desc:"Om een persoonlijke ervaring te bieden en onze website te verbeteren, plaatsen wij cookies.",buttons:{manage:"Beheer cookies",accept:"Ik accepteer cookies"}},manage:{title:"Cookie instellingen",desc:`Wij laten je graag een goede website zien, afgestemd op jouw voorkeuren.
    ...
    </li>`;return`<ul class="tdecc__links">${t}</ul>`};var Z=(e,t)=>{let o="";for(let n=0;n<e.length;n+=1){let c=n+1;o+=`<div class="tdecc__manage__option">
  ...
  </div>`;var F=()=>{let{content:e}=globalThis.tdecc,{config:t}=globalThis.tdecc;return!e||!e?(a("Content and config not found"),""):`
    ...
    </div>`},q=F;var X=()=>{switch(i().style){case"popup":return"popup";default:return"bar"}},d=()=>{document.body.className=document.body.className.replace(/\bshow-tdecc-overlay--popup|show-tdecc-overlay--bar|show-tdecc-overlay--closeable|show-tdecc-overlay\b/g,"")},l=(e=void 0)=>{(e||!i().exceptionUrls.find(t=>t===window.location.pathname))&&(document.body.className+=` show-tdecc-overlay show-tdecc-overlay--${X()}`),e&&(document.body.className+=" show-tdecc-overlay--closeable")},W=()=>{let e=document.createElement("div");e.className="tdecc",e.innerHTML=q(),document.body.appendChild(e)},J=()=>{let e=m(),{wrapper:t}=s();if(!t||!t||!e.length)return;t.querySelectorAll('input[type="radio"]').forEach(n=>{n.value==="0"&&(n.checked=!0)});for(let n=0;n<e.length;n+=1)t.querySelectorAll(`input[name="${e[n]}"][value="1"]`).forEach(r=>{r.checked=!0})},g=()=>{let e=s();e.wrapper&&i().manageable&&(e.sectionStart&&(e.sectionStart.style.display="none"),e.sectionManage&&(e.sectionManage.style.display="block"))};var u=()=>{document.dispatchEvent(new Event("tdecc-changed"))},Q=()=>{let{wrapper:e}=s();e&&e.querySelectorAll('input[type="radio"][value="1"]').forEach(t=>{t.checked=!0})},x=(e,t)=>{!e||!t||(L(i().cookieName,JSON.stringify({accepted:e,info:t}),365),globalThis.tdecc.cookies={accepted:e,info:t})},w=()=>{let e=s(),t=["cookie-accept-essential"],o={v:i().version,accepted:p()?.info?.accepted||new Date().toISOString(),updated:new Date().toISOString()};if(e.optionsAll.length/2!==e.optionsChoosen.length){e.errorMessage.style.display="block";return}e.optionsChoosen.forEach(n=>{n.value==="1"&&t.push(n.name)}),x(t,o),u(),d()};var B=()=>{let e=s();e.save&&e.save.addEventListener("click",t=>{t.preventDefault(),w()}),e.saveAll&&e.saveAll.forEach(t=>{t.addEventListener("click",o=>{o.preventDefault(),Q(),w()})}),e.close&&e.close.addEventListener("click",t=>{t.preventDefault(),d()}),e.manage&&e.manage.addEventListener("click",t=>{t.preventDefault(),g()})},C=()=>{let e=h();e.manage&&e.manage.forEach(t=>{t.addEventListener("click",o=>{o.preventDefault(),l(!0),g()})})};import K from"postscribe";var G=()=>{let{content:e}=globalThis.tdecc;return e?`
    ...
    </div>`:(a("Content not found"),"")};var ee=()=>Date.now().toString(36)+Math.random().toString(36).substr(2),te=e=>{if(e.dataset.tdeccIdentifier)return;let t=ee(),o=G();if(!o)return;let n=document.createElement("div");n.dataset.tdeccIdentifier=t,n.className="tdecc-notification",n.innerHTML=o,e.after(n),e.dataset.tdeccIdentifier=t},oe=e=>{let t=e.dataset.tdeccIdentifier;if(!t)return;let o=document.querySelector(`.tdecc-notification[data-tdecc-identifier="${t}"]`);o&&(o.outerHTML="")},U=()=>{let e=i();h(e).elements.forEach(t=>{if(!t.dataset.tdeccPermissions)return;let o=t.dataset.tdeccPermissions;if(o=o.replace(/\s+/g,""),!_(o.split(","))){t.hasAttribute("data-tdecc-show-notification")&&(te(t),delete t.dataset.tdeccShowNotification);return}oe(t);let n=document.createElement("textarea");n.innerHTML=t.innerHTML,K(t.parentElement,n.value),t.dataset.tdeccRendered="1"})};var T=()=>{O(i().cookieName)},R=()=>{let e=p(),t=i(),o=!0;if((!e.info||!e.info.v||e.info.v!==t.version)&&(o=!1),e.accepted||(o=!1),t.exceptionUrls.find(n=>n===window.location.pathname)&&(o=!0),o){globalThis.tdecc.cookies=e,u(),x(e.accepted,e.info);return}T()};import{SvelteComponent as ne,init as ce,safe_not_equal as re}from"svelte/internal";import{onMount as ie}from"svelte";function ae(e){return ie(()=>{console.log("SVELTE LOADED")}),[]}var S=class extends ne{constructor(t){super(),ce(this,t,ae,null,re,{})}},V=S;globalThis.tdecc=globalThis.tdecc||{};globalThis.tdecc.initialized=!1;globalThis.tdecc.accepted=[];globalThis.tdecc.info={};globalThis.tdecc.content={};var se=()=>({getAllPermissions(){return m()},checkPermission(e){return _(e)},show(){l(!0),g()},hide(){d()},update(){C(),u()},init(e){if(globalThis.tdecc.initialized)return;let t=A(e),o=j(),n=b(t.cookieName)||!1;if(globalThis.tdecc.config=t,globalThis.tdecc.content=o[t.language],globalThis.tdecc.config.consentOptions.unshift({key:"essential",title:globalThis.tdecc.content.permissions.essential.title,desc:globalThis.tdecc.content.permissions.essential.description,notCustomizable:!0}),globalThis.tdecc.getAllPermissions=this.getAllPermissions,globalThis.tdecc.checkPermission=this.checkPermission,globalThis.tdecc.show=this.show,globalThis.tdecc.hide=this.hide,globalThis.tdecc.update=this.update,document.addEventListener("tdecc-changed",()=>{U()}),W(),new V({target:document.body}),n)try{R(),J()}catch{T(),l()}else l();B(),C(),globalThis.tdecc.initialized=!0}}),Et=se();export{Et as default};
