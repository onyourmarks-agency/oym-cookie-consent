var V=Object.create;var _=Object.defineProperty;var Z=Object.getOwnPropertyDescriptor;var F=Object.getOwnPropertyNames;var X=Object.getPrototypeOf,ee=Object.prototype.hasOwnProperty;var te=(e,t)=>{for(var o in t)_(e,o,{get:t[o],enumerable:!0})},E=(e,t,o,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let c of F(t))!ee.call(e,c)&&c!==o&&_(e,c,{get:()=>t[c],enumerable:!(n=Z(t,c))||n.enumerable});return e};var oe=(e,t,o)=>(o=e!=null?V(X(e)):{},E(t||!e||!e.__esModule?_(o,"default",{value:e,enumerable:!0}):o,e)),ne=e=>E(_({},"__esModule",{value:!0}),e);var ge={};te(ge,{default:()=>ue});module.exports=ne(ge);var w={consentOptions:[],cookieName:"tdecc",exceptionUrls:[],explanationAnchors:[],language:"nl",manageable:!0,style:"bar",renderSelector:"[data-tdecc-render]",version:"1.0"};var z={splash:{title:"Mogen we even je aandacht?",desc:"Om een persoonlijke ervaring te bieden en onze website te verbeteren, plaatsen wij cookies.",buttons:{manage:"Beheer cookies",accept:"Ik accepteer cookies"}},manage:{title:"Cookie instellingen",desc:`Wij laten je graag een goede website zien, afgestemd op jouw voorkeuren.
    ...
    </div>`:(a("Content not found"),"")};var de=()=>Date.now().toString(36)+Math.random().toString(36).substr(2),se=e=>{if(e.dataset.tdeccIdentifier)return;let t=de(),o=U();if(!o)return;let n=document.createElement("div");n.dataset.tdeccIdentifier=t,n.className="tdecc-notification",n.innerHTML=o,e.after(n),e.dataset.tdeccIdentifier=t},le=e=>{let t=e.dataset.tdeccIdentifier;if(!t)return;let o=document.querySelector(`.tdecc-notification[data-tdecc-identifier="${t}"]`);o&&(o.outerHTML="")},pe=()=>{let e=i();b(e).elements.forEach(t=>{if(!t.dataset.tdeccPermissions)return;let o=t.dataset.tdeccPermissions;if(o=o.replace(/\s+/g,""),!h(o.split(","))){t.hasAttribute("data-tdecc-show-notification")&&(se(t),delete t.dataset.tdeccShowNotification);return}le(t);let n=document.createElement("textarea");n.innerHTML=t.innerHTML,(0,R.default)(t.parentElement,n.value),t.dataset.tdeccRendered="1"})},Y=pe;var S=()=>{D(i().cookieName)},K=()=>{let e=p(),t=i(),o=!0;if((!e.info||!e.info.v||e.info.v!==t.version)&&(o=!1),e.accepted||(o=!1),t.exceptionUrls.find(n=>n===window.location.pathname)&&(o=!0),o){window.tdecc.cookies=e,g(),k(e.accepted,e.info);return}S()};window.tdecc=window.tdecc||{};window.tdecc.initialized=!1;window.tdecc.accepted=[];window.tdecc.info={};window.tdecc.content={};var me=()=>({getAllPermissions(){return m()},checkPermission(e){return h(e)},show(){l(!0),u()},hide(){s()},update(){T(),g()},init(e){if(window.tdecc.initialized)return;let t=L(e),o=j(),n=v(t.cookieName)||!1;if(window.tdecc.config=t,window.tdecc.content=o[t.language],window.tdecc.getAllPermissions=this.getAllPermissions,window.tdecc.checkPermission=this.checkPermission,window.tdecc.show=this.show,window.tdecc.hide=this.hide,window.tdecc.update=this.update,document.addEventListener("tdecc-changed",()=>{Y()}),J(),n)try{K(),Q()}catch{S(),l()}else l();G(),T(),window.tdecc.initialized=!0}}),ue=me();
