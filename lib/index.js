var Z=Object.create;var b=Object.defineProperty;var F=Object.getOwnPropertyDescriptor;var X=Object.getOwnPropertyNames;var K=Object.getPrototypeOf,ee=Object.prototype.hasOwnProperty;var te=(e,t)=>{for(var o in t)b(e,o,{get:t[o],enumerable:!0})},E=(e,t,o,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let c of X(t))!ee.call(e,c)&&c!==o&&b(e,c,{get:()=>t[c],enumerable:!(n=F(t,c))||n.enumerable});return e};var oe=(e,t,o)=>(o=e!=null?Z(K(e)):{},E(t||!e||!e.__esModule?b(o,"default",{value:e,enumerable:!0}):o,e)),ne=e=>E(b({},"__esModule",{value:!0}),e);var ge={};te(ge,{default:()=>me});module.exports=ne(ge);var k={consentOptions:[],cookieName:"tdecc",exceptionUrls:[],explanationAnchors:[],language:"nl",manageable:!0,style:"bar",renderSelector:"[data-tdecc-render]",version:"1.0"};var z={splash:{title:"Mogen we even je aandacht?",desc:"Om een persoonlijke ervaring te bieden en onze website te verbeteren, plaatsen wij cookies.",buttons:{manage:"Beheer cookies",accept:"Ik accepteer cookies"}},manage:{title:"Cookie instellingen",desc:`Wij laten je graag een goede website zien, afgestemd op jouw voorkeuren.
  ...
  </div>`;var ie=()=>{let{content:e}=globalThis.tdecc,{config:t}=globalThis.tdecc;return!e||!e?(a("Content and config not found"),""):`
    ...
    </div>`},W=ie;var ae=()=>{switch(i().style){case"popup":return"popup";default:return"bar"}},d=()=>{document.body.className=document.body.className.replace(/\bshow-tdecc-overlay--popup|show-tdecc-overlay--bar|show-tdecc-overlay--closeable|show-tdecc-overlay\b/g,"")},l=(e=void 0)=>{(e||!i().exceptionUrls.find(t=>t===window.location.pathname))&&(document.body.className+=` show-tdecc-overlay show-tdecc-overlay--${ae()}`),e&&(document.body.className+=" show-tdecc-overlay--closeable")},J=()=>{let e=document.createElement("div");e.className="tdecc",e.innerHTML=W(),document.body.appendChild(e)},Q=()=>{let e=m(),{wrapper:t}=s();if(!t||!t||!e.length)return;t.querySelectorAll('input[type="radio"]').forEach(n=>{n.value==="0"&&(n.checked=!0)});for(let n=0;n<e.length;n+=1)t.querySelectorAll(`input[name="${e[n]}"][value="1"]`).forEach(r=>{r.checked=!0})},g=()=>{let e=s();e.wrapper&&i().manageable&&(e.sectionStart&&(e.sectionStart.style.display="none"),e.sectionManage&&(e.sectionManage.style.display="block"))};var u=()=>{document.dispatchEvent(new Event("tdecc-changed"))},B=()=>{let{wrapper:e}=s();e&&e.querySelectorAll('input[type="radio"][value="1"]').forEach(t=>{t.checked=!0})},w=(e,t)=>{!e||!t||(O(i().cookieName,JSON.stringify({accepted:e,info:t}),365),globalThis.tdecc.cookies={accepted:e,info:t})},C=()=>{let e=s(),t=["cookie-accept-essential"],o={v:i().version,accepted:p()?.info?.accepted||new Date().toISOString(),updated:new Date().toISOString()};if(e.optionsAll.length/2!==e.optionsChoosen.length){e.errorMessage.style.display="block";return}e.optionsChoosen.forEach(n=>{n.value==="1"&&t.push(n.name)}),w(t,o),u(),d()};var G=()=>{let e=s();e.save&&e.save.addEventListener("click",t=>{t.preventDefault(),C()}),e.saveAll&&e.saveAll.forEach(t=>{t.addEventListener("click",o=>{o.preventDefault(),B(),C()})}),e.close&&e.close.addEventListener("click",t=>{t.preventDefault(),d()}),e.manage&&e.manage.addEventListener("click",t=>{t.preventDefault(),g()})},T=()=>{let e=h();e.manage&&e.manage.forEach(t=>{t.addEventListener("click",o=>{o.preventDefault(),l(!0),g()})})};var R=oe(require("postscribe"));var U=()=>{let{content:e}=globalThis.tdecc;return e?`
    ...
    </div>`:(a("Content not found"),"")};var se=()=>Date.now().toString(36)+Math.random().toString(36).substring(2),de=e=>{if(e.dataset.tdeccIdentifier)return;let t=se(),o=U();if(!o)return;let n=document.createElement("div");n.dataset.tdeccIdentifier=t,n.className="tdecc-notification",n.innerHTML=o,e.after(n),e.dataset.tdeccIdentifier=t},le=e=>{let t=e.dataset.tdeccIdentifier;if(!t)return;let o=document.querySelector(`.tdecc-notification[data-tdecc-identifier="${t}"]`);o&&(o.outerHTML="")},Y=()=>{let e=i();h(e).elements.forEach(t=>{if(!t.dataset.tdeccPermissions)return;let o=t.dataset.tdeccPermissions;if(o=o.replace(/\s+/g,""),!v(o.split(","))){t.hasAttribute("data-tdecc-show-notification")&&(de(t),delete t.dataset.tdeccShowNotification);return}le(t);let n=document.createElement("textarea");n.innerHTML=t.innerHTML,(0,R.default)(t.parentElement,n.value),t.dataset.tdeccRendered="1"})};var S=()=>{D(i().cookieName)},V=()=>{let e=p(),t=i(),o=!0;if((!e.info||!e.info.v||e.info.v!==t.version)&&(o=!1),e.accepted||(o=!1),t.exceptionUrls.find(n=>n===window.location.pathname)&&(o=!0),o){globalThis.tdecc.cookies=e,u(),w(e.accepted,e.info);return}S()};globalThis.tdecc=globalThis.tdecc||{};globalThis.tdecc.initialized=!1;globalThis.tdecc.accepted=[];globalThis.tdecc.info={};globalThis.tdecc.content={};var pe=()=>({getAllPermissions(){return m()},checkPermission(e){return v(e)},show(){l(!0),g()},hide(){d()},update(){T(),u()},init(e){if(globalThis.tdecc.initialized)return;let t=j(e),o=L(),n=_(t.cookieName)||!1;if(globalThis.tdecc.config=t,globalThis.tdecc.content=o[t.language],globalThis.tdecc.config.consentOptions.unshift({key:"essential",title:globalThis.tdecc.content.permissions.essential.title,desc:globalThis.tdecc.content.permissions.essential.description,notCustomizable:!0}),globalThis.tdecc.getAllPermissions=this.getAllPermissions,globalThis.tdecc.checkPermission=this.checkPermission,globalThis.tdecc.show=this.show,globalThis.tdecc.hide=this.hide,globalThis.tdecc.update=this.update,document.addEventListener("tdecc-changed",()=>{Y()}),J(),n)try{V(),Q()}catch{S(),l()}else l();G(),T(),globalThis.tdecc.initialized=!0}}),me=pe();
